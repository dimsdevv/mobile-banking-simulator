      ...
      <div className="container mx-auto px-4 max-w-md py-6 space-y-6">
        ...
        <motion.div initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.05 }}>
          <SectionCard>
            <SectionHeader icon={<Pencil size={18} />} title="Informasi Pribadi" action={
              !isEditing ? (
                <button onClick={() => setIsEditing(true)} className="text-sm text-primary-600 font-medium hover:underline">
                  Ubah
                </button>
              ) : null
            } />
            ...
            {!isEditing ? (
              ...
              <div className="space-y-4 mt-4">
                ...
                <div className="flex gap-3 pt-2">
                  <Button variant="outline" className="flex-1" onClick={() => { setIsEditing(false); setEditName(user?.name); setEditEmail(user?.email) }}>
                    Batal
                  </Button>
                  <Button className="flex-1" onClick={handleSaveProfile} isLoading={saving}>
                    Simpan
                  </Button>
                </div>
              </div>
        ...
        <motion.div initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.15 }}>
          <SectionCard>
            ...
            <div className="mt-4">
              <button className="w-full flex items-center justify-between p-3 rounded-2xl hover:bg-slate-100 dark:hover:bg-slate-800/50 transition-colors text-left">
          ...
          >
            ...
            >
              <div className="flex items-center justify-between">
                ...
                <button onClick={() => setShowAbout(false)} className="w-8 h-8 rounded-full bg-slate-100 dark:bg-slate-800 flex items-center justify-center">
                  <X size={18} />
                </button>
              </div>
              ...
              <div className="space-y-2 text-sm text-slate-600 dark:text-slate-300">
                <p>
                  SimBank adalah aplikasi simulasi mobile banking yang dibuat sebagai
                  <span className="font-semibold text-primary-600"> portfolio showcase</span>.
                  Seluruh data bersifat dummy — tidak ada integrasi dengan bank atau payment gateway sungguhan.
                </p>
              </div>
              ...
              <a
                href="https://github.com/dimsdevv/mobile-banking-simulator"
                target="_blank"
